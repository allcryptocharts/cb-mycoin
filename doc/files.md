...
* mycoin.conf: contains configuration settings for mycoind or mycoin-qt
* mycoind.pid: stores the process id of mycoind while running
...
* debug.log: contains debug information and general logging generated by mycoind or mycoin-qt
