...
* Update manpages, see [gen-manpages.sh](https://github.com/mycoin-project/mycoin/blob/master/contrib/devtools/README.md#gen-manpagessh).
...
### MyCoin maintainers/release engineers, suggestion for writing release notes
...
### Build and sign MyCoin Core for Linux, Windows, and OS X:
    ...
    pushd ./gitian-builder
    ./bin/gbuild --num-make 2 --memory 3000 --commit mycoin=v${VERSION} ../mycoin/contrib/gitian-descriptors/gitian-linux.yml
    ...
    ./bin/gbuild --num-make 2 --memory 3000 --commit mycoin=v${VERSION} ../mycoin/contrib/gitian-descriptors/gitian-win.yml
    ...
    ./bin/gbuild --num-make 2 --memory 3000 --commit mycoin=v${VERSION} ../mycoin/contrib/gitian-descriptors/gitian-osx.yml
...
Codesigner only: Sign the osx binary:
    ...
    transfer mycoin-osx-unsigned.tar.gz to osx for signing
    tar xf mycoin-osx-unsigned.tar.gz
...
Codesigner only: Sign the windows binaries:
    ...
    tar xf mycoin-win-unsigned.tar.gz
...
- Announce the release:
  ...
  - mycoin-dev and mycoin-dev mailing list

  - blog.mycoin.org blog post

  - Update title of #mycoin and #mycoin-dev on Freenode IRC

  - Optionally twitter, reddit /r/MyCoin, ... but this will usually sort out itself

  - Archive release notes for the new version to `doc/release-notes/` (branch `master` and branch of the release)

  - Create a [new GitHub release](https://github.com/mycoin-project/mycoin/releases/new) with a link to the archived release notes.
