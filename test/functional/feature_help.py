...
"""Verify that starting mycoin with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start mycoin with -h for help text")
        ...
        self.log.info("Start mycoin with -version for version information")
