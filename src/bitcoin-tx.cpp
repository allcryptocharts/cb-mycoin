...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s mycoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  mycoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded mycoin transaction") + "\n" +
              "  mycoin-tx [options] -create [commands]   " + _("Create hex-encoded mycoin transaction") + "\n" +
              "\n";
